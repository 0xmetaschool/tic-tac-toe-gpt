...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/tic-tac-toe-gpt');
  ...
  return (
    <footer className="mt-188px w-full border-t border-gray-200 shadow-[0_-1px_4px_rgba(0,0,0,0.05)]">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="text-gray-500 text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-slate-100 max-w-[220px]">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com/0xmetaschool/tic-tac-toe-gpt/fork"
